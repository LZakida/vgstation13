					...
					//2
					 list(Co_DESC="External armor is installed.",
					 	...
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/crowbar,
					 		"verb_2nd" = "pry",
					 		"verb_3rd" = "pries",
					 		Co_VIS_MSG = "{USER} {VERB} external armor layer from {HOLDER}.",
					 ...
					 list(Co_DESC="Internal armor is installed",
					 	...
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/crowbar,
					 		"verb_2nd" = "pry",
					 		"verb_3rd" = "pries",
					 		Co_VIS_MSG = "{USER} {VERB} internal armor layer from {HOLDER}.")
					 	),
					 //6
					 ...
					 list(Co_DESC="Central control module is secured",
					 	Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/ripley/peripherals,
					 		Co_AMOUNT = 1,
					 ...
					 list(Co_DESC="The wiring is adjusted",
						Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/ripley/main,
					 		Co_AMOUNT = 1,
...
/datum/construction/reversible/mecha/odysseus
	...
	steps = list(
					...
					//2
					 ...
					 //8
					 list(Co_DESC="Central control module is secured",
					 	Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/odysseus/peripherals,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the peripherals control module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} unfasten{s} the mainboard.")
					 ...
					 //10
					 list(Co_DESC="The wiring is adjusted",
						Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/odysseus/main,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the central control module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} disconnect{s} the wiring of {HOLDER}.")
					...
					//2
					 list(Co_DESC="External armor is installed.",
					 	...
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/crowbar,
					 		"verb_2nd" = "pry",
					 		"verb_3rd" = "pries",
					 		Co_VIS_MSG = "{USER} {VERB} armor plates from {HOLDER}.",
					 		Co_DELAY = 30,
					 		Co_START_MSG = "{USER} begin{s} removing the armor plates...")
					 	),
					 //3
					 list(Co_DESC="Internal armor is welded.",
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/mecha_parts/part/gygax_armour,
					 		Co_AMOUNT = 1,
					 ...
					 //12
					 list(Co_DESC="Peripherals control module is secured",
					 	Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/gygax/targeting, //set by proc
					 		Co_AMOUNT = 1,
					 ...
					 //14
					 list(Co_DESC="Central control module is secured",
					 	Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/gygax/peripherals,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the peripherals control module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} unfasten{s} the mainboard.")
					 ...
					 //16
					 list(Co_DESC="The wiring is adjusted",
						Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/gygax/main,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the central control module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} disconnect{s} the wiring of {HOLDER}.")
...
/datum/construction/reversible/mecha/combat/durand
	...
	steps = list(
					...
					//2
					 ...
					 //3
					 list(Co_DESC="Internal armor is welded.",
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/mecha_parts/part/durand_armour,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} armor plates to {HOLDER}.",
					 		Co_START_MSG = "{USER} begin{s} installing the armor plates...",
					 		Co_DELAY = 30),
					 ...
					 list(Co_DESC="Advanced capacitor is secured",
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/stack/sheet/metal,
					 		...
					 		Co_VIS_MSG = "{USER} install{s} internal armor layer to {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} unfasten{s} the super capacitor.")
					 	),
					 //7
					 list(Co_DESC="Advanced capacitor is installed",
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} secure{s} the super capacitor."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/crowbar,
					 		Co_VIS_MSG = "{USER} remove{s} the super capacitor from {HOLDER}.")
					 	),
					 //8
					 list(Co_DESC="Phasic scanner module is secured",
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/weapon/stock_parts/capacitor/adv/super,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} super capacitor to {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} unfasten{s} the phasic scanner module.")
					 	),
					 //9
					 list(Co_DESC="Phasic scanner module is installed",
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} secure{s} the phasic scanner module."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/crowbar,
					 		Co_VIS_MSG = "{USER} remove{s} the phasic scanner module from {HOLDER}.")
					 	),
					 //10
					 list(Co_DESC="Targeting module is secured",
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/weapon/stock_parts/scanning_module/adv/phasic,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} phasic scanner module to {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} unfasten{s} the targeting module.")
					 	),
					 //11
					 ...
					 //12
					 list(Co_DESC="Peripherals control module is secured",
					 	Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/durand/targeting, //set by proc
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the targeting module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} unfasten{s} the peripherals control module.")
					 ...
					 //14
					 list(Co_DESC="Central control module is secured",
					 	Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/durand/peripherals,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the peripherals control module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} unfasten{s} the mainboard.")
					 ...
					 //16
					 list(Co_DESC="The wiring is adjusted",
						Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/durand/main,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the central control module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} disconnect{s} the wiring of {HOLDER}.")
...
/datum/construction/reversible/mecha/combat/marauder
	...
	steps = list(
					...
					//2
					 ...
					 //3
					 list(Co_DESC="Internal armor is welded.",
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/mecha_parts/part/marauder_armour,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} armor plates to {HOLDER}.",
					 		Co_START_MSG = "{USER} begin{s} installing the armor plates...",
					 		Co_DELAY = 30),
					 ...
					 //12
					 list(Co_DESC="Peripherals control module is secured",
					 	Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/marauder/targeting, //set by proc
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the targeting module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} unfasten{s} the peripherals control module.")
					 ...
					 //14
					 list(Co_DESC="Central control module is secured",
					 	Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/marauder/peripherals,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the peripherals control module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} unfasten{s} the mainboard.")
					 ...
					 //16
					 list(Co_DESC="The wiring is adjusted",
						Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/marauder/main,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the central control module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} disconnect{s} the wiring of {HOLDER}.")
...
/datum/construction/reversible/mecha/reticence
	...
	steps = list(
					 list(
					 	Co_NEXTSTEP = list(Co_KEY=null,
						Co_AMOUNT = 1,
					 	Co_VIS_MSG = "The reticence likewise {EMOTE}")
					 	),//1
					 list(
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/clothing/suit/suspenders,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} put{s} suspenders on {HOLDER}.")
					 	),//2
					 list(
					 	Co_NEXTSTEP = list(Co_KEY=null,
					 	Co_AMOUNT = 1,
					 ...
					 list(
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/clothing/mask/gas/mime,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} put{s} the mime mask on {HOLDER}.")
					 	),//4
					 list(
					 	Co_NEXTSTEP = list(Co_KEY=null,
					 	Co_AMOUNT = 1,
					 ...
					 list(
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/clothing/head/beret,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} put{s} the beret on {HOLDER}.")
					 	),//6
					 list(
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/weapon/circuitboard/mecha/reticence/targeting,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the weapon control module into {HOLDER}.")
					 	),//7
					 list(
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/weapon/circuitboard/mecha/reticence/peripherals,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the peripherals control module into {HOLDER}.")
					 	),//8
					 list(
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/weapon/circuitboard/mecha/reticence/main,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the central control module into {HOLDER}.")
					 	)//9
)
...
/datum/construction/reversible/mecha/phazon
	...
	steps = list(
					...
					//2
					 ...
					 //10
					 list(Co_DESC="Central control module is secured",
					 	Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/phazon/peripherals,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the peripherals control module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} unfasten{s} the mainboard.")
					 ...
					 //12
					 list(Co_DESC="The wiring is adjusted",
						Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/phazon/main,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the central control module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} disconnect{s} the wiring of {HOLDER}.")
...
/datum/construction/reversible/mecha/clarke
	...
	steps = list(
					...
					//2
					 ...
					 //8
					 list(Co_DESC="Central control module is secured",
					 	Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/clarke/peripherals,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the peripherals control module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} unfasten{s} the mainboard.")
					 ...
					 //10
					 list(Co_DESC="The wiring is adjusted",
						Co_NEXTSTEP = list(Co_KEY= /obj/item/weapon/circuitboard/mecha/clarke/main,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the central control module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/weapon/screwdriver,
					 		Co_VIS_MSG = "{USER} disconnect{s} the wiring of {HOLDER}.")
